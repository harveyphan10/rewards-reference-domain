...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		ResponseEntity<Beneficiary> newBeneficiary = restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);
		assertThat(newBeneficiary.getStatusCode()).isEqualTo(HttpStatus.OK);
		assertNotNull(newBeneficiary.getBody());
		assertThat(newBeneficiary.getBody().getName()).isEqualTo("David");

		restTemplate.delete(newBeneficiaryLocation);
		ResponseEntity<Beneficiary> davidEntity = restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);
		assertThat(davidEntity.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
	}
