...
public class RewardsApplication {
    ...
    public CommandLineRunner commandLineRunner(JdbcTemplate jdbcTemplate) {
        ...
        System.out.println("Hello, there are " + count + " accounts");
        return args -> logger.info("Hello, there are " + count + " accounts");
    }

    @Bean
    public CommandLineRunner displayRewardRecipientProperties(RewardsRecipientProperties rewardsRecipientProperties) {
        return args -> {logger.info(rewardsRecipientProperties.toString());};
    }
