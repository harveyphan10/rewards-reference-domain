...
public class AccountControllerTests {
	...
	public void testHandleDetailsRequest() {
		...
		Account foundAccount = controller.accountDetails(expectedAccountId);
		...
		assertEquals(expectedAccountId, foundAccount.getEntityId());
		assertEquals(expectedAccountNumber, foundAccount.getNumber());
	}
